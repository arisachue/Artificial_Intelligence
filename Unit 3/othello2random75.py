...
def max_step(board, depth, alpha, beta): # return max weight of future outcome
    ...
    if depth == 0:
# =============================================================================
#         CHANGES, when board 75% filled, takes into account # of tokens taken
# =============================================================================
        if xcount+ocount > 50:
            return score_later(board, xMoves, oMoves, xcount, ocount)
        return score(board, xMoves, oMoves, xcount, ocount)
